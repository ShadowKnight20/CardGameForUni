...
public class CardDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //Melee
        cardList.Add(new Card(1, "Swordman", 1, Resources.Load<Sprite>("SwordmanCard"), 2, 3, 13, 20, false,0, false, 0, ""));
        cardList.Add(new Card(2, "Knight", 2, Resources.Load<Sprite>("KnightCard"), 4, 5, 15, 25, false, 0, false, 0, ""));
        cardList.Add(new Card(3, "Mounted Knight", 3, Resources.Load<Sprite>("HeadKnightmanCrad"), 5, 5, 17, 30, false, 0, false, 0, ""));

        //Ranged

        cardList.Add(new Card(4, "Archer", 1, Resources.Load<Sprite>("ArcherCard"), 2, 0, 13, 20, true, 3, false, 0, ""));
        cardList.Add(new Card(5, "Catapult", 1, Resources.Load<Sprite>("WeaponCard"), 4, 0, 13, 20, true, 6, false, 0, ""));
        cardList.Add(new Card(6, "Sorcerer", 1, Resources.Load<Sprite>("MageCard"), 5, 5, 13, 20, true, 5, false, 0, ""));
        ////Human Spells

        cardList.Add(new Card(7, "Sign", 1, Resources.Load<Sprite>("Spell1Card"), 0, 0, 0, 0, false, 0, true, -2, "Get 2 points"));
        cardList.Add(new Card(8, "Dragon", 1, Resources.Load<Sprite>("Spell2Card"), 0, 0, 0, 0, false, 0, true, 0, "Destroy 1 opponent's card")); //need to add card removal from opponent 
        ...
        cardList.Add(new Card(10, "Armour", 1, Resources.Load<Sprite>("Equipment2Card"), 0, 0, 5, 0, false, 0, true, 0, ""));
